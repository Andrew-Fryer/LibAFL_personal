...
use alloc::rc::Weak;
use alloc::vec::Vec;
use combinator_fuzzer::core::context::Children;
use combinator_fuzzer::core::context::Context;
use combinator_fuzzer::core::bit_array::BitArray;
use combinator_fuzzer::dns;
use rand::Rng;
...
/// The [`InputFeedback`] uses input from the SUT
#[derive(Serialize, Deserialize, Clone, Debug)]
...
impl InputFeedback {
    ...
    pub fn new_with_observer(observer: &InputObserver) -> Self {
        Self::new(observer.name().to_string())
    }
}

/// The [`OutputFeedback`] uses output from the SUT
// #[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq, Eq)]
#[derive(Serialize, Deserialize, Clone, Debug)]
